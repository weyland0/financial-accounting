...
export function UpdateCounterpartyModal({ isOpen, onClose, onUpdated, oldFormData }) {
  ...
  const [formData, setFormData] = useState({
    ...
    category: oldFormData?.category || '',
    phone: oldFormData?.phone || '',
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const data = await updateCounterparty(oldFormData.id, payload);
      setSuccess(true);
      if (onUpdated) 
        onUpdated(data);
